...
IOS_PRESET="${IOS_PRESET:-iOS}"
IOS_EXT="${IOS_EXT:-.ipa}"
IOS_SUBDIR="${IOS_SUBDIR:-ios}"

EXPORT_DIR_ABS="${PROJECT_ROOT}/${EXPORT_DIR}/${IOS_SUBDIR}"
EXPORT_PATH="${EXPORT_PATH:-${EXPORT_DIR_ABS}/${EXPORT_NAME}${IOS_EXT}}"
...
godot_export_release() {
    ...
    "$GODOT_BIN" --headless --path "$GODOT_PROJECT_DIR" --export-release "$IOS_PRESET" "$EXPORT_PATH"
}

main() {
    echo "=== 开始打包 iOS 版本 ==="
    echo "项目根目录: $PROJECT_ROOT"
    echo "导出预设: $IOS_PRESET"
